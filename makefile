...
GCCOPTIONS=-fPIC -Wall --std=c++17 $(MESENFLAGS)
CCOPTIONS=-fPIC -Wall $(MESENFLAGS)
...
.PHONY: thug
CORE_OBJS=$(wildcard ./Core/obj.x64/*.o) $(shell find Utilities/ -name "*.o") $(shell find SevenZip/obj.x64 -name "*.o") $(shell find Lua/obj.x64/ -name "*.o")
thug: thug/main.o 
	$(CPPC) $(GCCOPTIONS) $(LINKOPTIONS) -pthread -o thug/thug $^ $(CORE_OBJS) -lstdc++fs


thug/main.o: thug/main.cpp
	$(CPPC) -ICore $(GCCOPTIONS) $^ -c -o $@
